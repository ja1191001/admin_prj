    ...
    <tr>
      ...
      <td width=800 height=600 align=center valign=top>
      	<div style="margin:0px auto;text-align: center">
			사원의 관리자 아이디는 <c:out value="${ requestScope.ad_id }"/><br/>
			<a href="start.do"><input type="button" class="btn" value="Login"/></a>
			<a href="main/find_pass.jsp"><input type="button" class="btn" value="비밀번호 찾기"/></a>
		</div>
      </td>
    </tr>
