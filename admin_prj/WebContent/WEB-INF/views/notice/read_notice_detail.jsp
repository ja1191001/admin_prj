												...
												<tr>
													<td colspan="4" align="left"
														...
														<textarea rows="30" cols="110"><c:out
																value="${requestScope.detail_data.content }" /></textarea>
													</td>
												</tr>
											</tbody>
										</table>
										<div align="right">
											<a href="notice_modify.do?num=${ requestScope.detail_data.num }" ><input type="submit" class="btn" value="수정"></a>
											<a href="notice_delete.do" onclick="chkDelete();return false;"><input type="button" class="btn" value="삭제" ></a>
										</div>
								</div>
								<div></div>
								<div align="center">
									<c:if test="${1 < requestScope.detail_data.num }">
										<a
											href="read_notice_detail.do?num=${ requestScope.detail_data.num-1 }"><input
											type="button" class="btn" value="이전 글"></a>
									</c:if>
									<c:if test="${ not empty (requestScope.detail_data.num+1) }">
										<a
											href="read_notice_detail.do?num=${ requestScope.detail_data.num+1 }"><input
											type="button" class="btn" value="다음 글"></a>
									</c:if>
